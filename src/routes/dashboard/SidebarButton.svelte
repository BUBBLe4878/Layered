...
<a
	...
	class={`pei-button pei1 flex h-12 items-center rounded-lg justify-center gap-1.5 shadow-xl/3 transition-colors hover:outline-primary-100 2xl:h-13 ${pei ? `pei${pei}` : ''} ${
		admin
