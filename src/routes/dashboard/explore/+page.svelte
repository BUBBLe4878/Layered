<script lang="ts">
	...
	async function loadMore() {
		...
		try {
			const res = await fetch(`/dashboard/explore?offset=${nextOffset}&sort=${sortBy}`);
	...
	<div class="contests-section">
		...
		{#if contests.length > 0}
			<div class="contests-viewport">
				<div class="contests-track" style="transform: translateX(-{currentIndex * 100}%)">
						...
						<div class="contest-card">
							...
							<div class="contest-image-wrapper">
								...
								<div
									...
									class:badge-ending={status === 'ending-soon'}
									class:badge-ended={status === 'ended'}
								>
									{#if status === 'active'}
	...
	<div class="leaderboard-container">
		<div class="leaderboard">
			{#each leaderboard as user, i}
				<button onclick={() => (selectedUser = user)} class="leaderboard-item">
						...
						<div class="stat-breakdown">
							<div class="breakdown-bar">
								<div
									...
									style="width: {selectedUser.score > 0
										? ((selectedUser.totalHours * 0.3) / selectedUser.score) * 100
										: 0}%"
								></div>
							</div>
							<div class="breakdown-text">
								{(selectedUser.totalHours * 0.3).toFixed(2)} pts (30%)
							</div>
						</div>
					</div>
						...
						<div class="stat-breakdown">
							<div class="breakdown-bar">
								<div
									class="breakdown-fill"
									style="width: {selectedUser.score > 0
										? ((selectedUser.totalLogs * 0.3) / selectedUser.score) * 100
										: 0}%"
								></div>
							</div>
							<div class="breakdown-text">
								{(selectedUser.totalLogs * 0.3).toFixed(2)} pts (30%)
							</div>
						</div>
					</div>
						...
						<div class="stat-breakdown">
							<div class="breakdown-bar">
								<div
									class="breakdown-fill"
									style="width: {selectedUser.score > 0
										? ((selectedUser.totalLikes * 0.2) / selectedUser.score) * 100
										: 0}%"
								></div>
							</div>
							<div class="breakdown-text">
								{(selectedUser.totalLikes * 0.2).toFixed(2)} pts (20%)
							</div>
						</div>
					</div>
						...
						<div class="stat-breakdown">
							<div class="breakdown-bar">
								<div
									class="breakdown-fill"
									style="width: {selectedUser.score > 0
										? ((selectedUser.totalClay * 0.2) / selectedUser.score) * 100
										: 0}%"
								></div>
							</div>
							<div class="breakdown-text">
								{(selectedUser.totalClay * 0.2).toFixed(2)} pts (20%)
							</div>
						</div>
					</div>
				</div>
